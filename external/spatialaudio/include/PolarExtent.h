...
*/
class SA_API CSpreadPannerBase
{
public:
	CSpreadPannerBase();
	~CSpreadPannerBase();
...
*/
class SA_API CSpreadPanner : private CSpreadPannerBase
{
public:
...
*/
class SA_API CAmbisonicSpreadPanner : private CSpreadPannerBase
{
public:
...
*/
class SA_API CPolarExtentHandlerBase
{
public:
...
/**
	Class that handles the extent parameters to calculate a gain vector
*/
class SA_API CPolarExtentHandler : public CPolarExtentHandlerBase
{
public:
...
*/
class SA_API CAmbisonicPolarExtentHandler : public CPolarExtentHandlerBase
{
public:
