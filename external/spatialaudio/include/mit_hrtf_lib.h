...
*/
SA_API unsigned int mit_hrtf_availability(int azimuth, int elevation, unsigned int samplerate);
...
/**
    ...
    was an error.
*/
SA_API unsigned int mit_hrtf_get(int* pAzimuth, int* pElevation, unsigned int samplerate, short* psLeft, short* psRight);
