 ...
 */
// 文件路径: C:\Users\sammi\CLionProjects\mlt\external\vid.stab\src\motiondetect.c

/*
 * This function calculates the relative motions between this frame and the previous one, based on the fields.
 * The function returns a vector (VSVector of type LocalMotion) of the motions of the fields
 * or NULL if no fields available. The caller has to free the vector.
 */
